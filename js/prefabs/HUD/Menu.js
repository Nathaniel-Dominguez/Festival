// The Menu prefab ha an array of MenuItems and allows navigating through them when it is enabled.
// Since we will have more then one menue we need methods to enable and disable them.
// The enable method will add callbacks to the keyboard to allow menu navigation.
// The other methods will be used later
